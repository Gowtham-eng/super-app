          ...
          <form onSubmit={handleUpdate} className="flex flex-col flex-1 min-h-0">
            <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div className="sm:col-span-2">
                  <Label className="label-uppercase text-xs">Work Email *</Label>
                  <Input
                    type="email"
                    ...
                    placeholder="john@refex.co.in"
                    data-testid="edit-email-input"
                  />
                  <p className="text-[11px] text-amber-600 mt-1">⚠️ Changing email updates login credentials and syncs to Kissflow</p>
                </div>
                <div className="sm:col-span-2">
